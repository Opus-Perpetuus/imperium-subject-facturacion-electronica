...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-facturacion-electronica"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-facturacion-electronica"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-facturacion-electronica \
    KIRLET_TECHNICAL_ID=subject-facturacion-electronica \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
